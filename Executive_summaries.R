...
Exesum_m2_NBO_main <- HTML("
  <ul style='text-align: justify; font-size: 15px;padding: 15px;'>
    <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vehicula elit vel tellus euismod, a aliquam dolor viverra.</li>
    <hr style='border: 1px solid #d3d3d3;' />
    <li>Proin condimentum orci at metus convallis, nec viverra nisl malesuada. Maecenas convallis risus id erat vehicula, in egestas lorem euismod.</li>
    <hr style='border: 1px solid #d3d3d3;' />
  </ul>
")
...
Exesum_m2_NBO <- HTML("
  <ul style='text-align: justify; font-size: 15px;'>
    <div><span style='color: #FEB70D;'>Lorem ipsum:</span> Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</div>
    <div><span style='color: #FEB70D;'>Dolor sit amet:</span> Eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</div>
  </ul>
")

Exesum_m2_HA_main <- HTML("
  <ul style='text-align: justify; font-size: 15px;padding: 15px;'>
    <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vehicula elit vel tellus euismod, a aliquam dolor viverra.</li>
    <hr style='border: 1px solid #d3d3d3;' />
    <li>Proin condimentum orci at metus convallis, nec viverra nisl malesuada. Maecenas convallis risus id erat vehicula, in egestas lorem euismod.</li>
